export const leaveTypes = [
  ...
  { label: 'Health/Sick', value: 'HEALTH/SICK' },
  ...
  export const orgDepartments = [
    { label: "Accounting and Finance", id: "1ea40bcd-b285-4405-84be-c5591c62dfd2", desc: "Handles money", users: [] },
    { label: "IT", id: "687d77fe-dfc1-4380-a1c5-3d2e30b1f42f", desc: "Develop Software", users: [] },
    { label: "Human Resources", id: "85c738e2-65ac-4a53-8ad1-2cb6cf43d3b4", desc: "Deals with human matters", users: [] },
    { label: "Sales and marketing", id: "843e8109-d4b8-4323-9433-2554e1704e7c", desc: "Runs operations", users: [] },
    { label: "Procurement", id: "39707d6f-4aba-4f49-8039-68e95b6f5e4e", desc: "Manages product development", users: [] },
  ] as const
