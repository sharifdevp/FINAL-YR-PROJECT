...
const EditBalances = ({ balance }: Props) => {
  const initialState: State = {
    ...
    sickCredit: balance.healthCredit as number,
    sickUsed: balance.healthUsed as number,
    sickAvailable: balance.healthAvailable as number,
    ...
    emergencyCredit: balance.emergencyCredit as number,
    emergencyUsed: balance.emergencyUsed as number,
    emergencyAvailable: balance.emergencyAvailable as number,
